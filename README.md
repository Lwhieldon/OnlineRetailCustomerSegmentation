...
This dataset contains 525,461 transactions* with 8 attributes explaining each instance. The transactions occurred for a UK-based and registered, non-store online retail between 1/12/2009 and 9/12/2011. 
...
*UCI machine learning repo indicates that there are 1,067,371 observations but data from source contains only 525,461 observations exist.